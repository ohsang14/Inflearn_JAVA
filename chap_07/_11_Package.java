...
public class _11_Package {
    public static void main(String[] args) {
        ...
        System.out.println("랜덤 정수(범위): "+ random.nextInt(10)); //0이상 10 미만 정수값
        System.out.println("랜덤 실수: " + random.nextDouble()); // 0.0이상 1.0 미만 실수값
//        System.out.println("랜덤 실수(범위)"+ random.nextDouble(10.0)) ;
        ...
        // nextInt(45) + 1 : 1 이상 46미만의 수 = 1이상 45 이하의 수
